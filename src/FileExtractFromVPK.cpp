...
static QStringList GetVpkList() {
    if (Miscellaneous::globalOptions.s1gamename == "css") {
        return {
    ...
    } else if (Miscellaneous::globalOptions.s1gamename == "hl2") {
        return {
            "hl2/hl2_sound_vo_english_dir.vpk",
            "hl2/hl2_pak_dir.vpk",
            "hl2/hl2_textures_dir.vpk",
    ...
    } else if (Miscellaneous::globalOptions.s1gamename == "l4d") {
        return {
            "left4dead/pak01_dir.vpk",
            "left4dead_dlc3/pak01_dir.vpk"
        };
    } else if (Miscellaneous::globalOptions.s1gamename == "l4d2") {
        return {
    ...
    } else if (Miscellaneous::globalOptions.s1gamename == "portal") {
        return {
    ...
    } else if (Miscellaneous::globalOptions.s1gamename == "portal2") {
        return {
            "portal2/pak01_dir.vpk",
            "portal2_dlc1/pak01_dir.vpk",
            "portal2_dlc2/pak01_dir.vpk"
        };
    } else if (Miscellaneous::globalOptions.s1gamename == "tf2") {
        return {
    ...
    } else if (Miscellaneous::globalOptions.s1gamename == "gmod") {
        return {
...
void FileExtractFromVPK::ExtractModel(const QString& filepath){
    ...
    QString contentPath = QDir(Miscellaneous::globalOptions.s1contentdir).filePath(filepath);
    QString outPath = QDir(Miscellaneous::globalOptions.s1gamedir).filePath(filepath);

    QString baseFolder = QFileInfo(Miscellaneous::globalOptions.s1gamedir).dir().absolutePath();
    ...
    if (!foundVpkPath.isEmpty()) {
        ...
        for (const QString& ext : extlist) {
            ...
            contentPath = QDir(Miscellaneous::globalOptions.s1contentdir).filePath(target);
            ...
            outPath = QDir(Miscellaneous::globalOptions.s1gamedir).filePath(target);
            if (QFile::exists(contentPath)) {
                QFile::copy(contentPath, outPath);
            }
        }
