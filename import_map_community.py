...
def ImportAndCompileMapRefs( refsFile, s2addon, errorCallback ):
	...
	tmpFile = s2contentcsgoimported + "\\maps\\" + mapname + "_compile_new_refs.txt"
...
if ( not skipdeps ):
	...
	StripMDLsFromRefs( s2contentcsgoimported + "\\maps\\" + mapname + "_refs.txt" )

	# now import mdls (as modeldoc), and their materials
	ImportAndCompileMapMDLs( s2contentcsgoimported + "\\maps\\" + mapname + "_mdl_lst.txt", s2addon, errorCallback )

	# import refs (excluding mdls)
	ImportAndCompileMapRefs( s2contentcsgoimported + "\\maps\\" + mapname + "_new_refs.txt", s2addon, errorCallback )
